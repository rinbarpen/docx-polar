...
description: |
  ...
  Activated as sub-skill of docx-write — triggered automatically during content
  generation when spec language is English and humanize is not explicitly disabled.
license: MIT
